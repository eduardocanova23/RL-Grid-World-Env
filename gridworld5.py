    ...
    def train_QLearning(self, n_episodes=1000000):
        ...
        for e in range(n_episodes):
            ...
            while (not self.terminated) and steps <= self.max_steps:
                ...
                self.table[self._agent_location[0],self._agent_location[1],self._left,self._right,self._up,self._down,action] = ((self.learning_rate*(reward+self.gamma*self.maxTable() 
