...
class GridWorldEnv8_1(gym.Env):
    ...
    def __init__(self,render_mode=None,size=4,exploration_max=0.90,exploration_min=0,exploration_decay=1.0,gamma=1,max_steps=18,learning_rate=1):
        ...
        self.reward_matrix = np.array([[-1,-1,-1,-1],[-1,-1,14,10], [-1, -1,-1,-1],[3, -1,-1,-1]])
        self.diamond_matrix = np.array([[-1,-1,-1,-1],[-1,-1,"y","g"], [-1, -1,-1,-1],["b", -1,-1,-1]])
        ...
        self.observation_space = spaces.Dict(
            {
                ...
                "00": spaces.Discrete(3),
                "01": spaces.Discrete(3),
                "02": spaces.Discrete(3),
                "03": spaces.Discrete(3),
                "10": spaces.Discrete(3),
                "11": spaces.Discrete(3),
                "12": spaces.Discrete(3),
                "13": spaces.Discrete(1),
                "20": spaces.Discrete(3),
                "21": spaces.Discrete(3),
                "22": spaces.Discrete(3),
                "23": spaces.Discrete(3),
                "30": spaces.Discrete(3),
                "31": spaces.Discrete(3),
                "32": spaces.Discrete(3),
                "33": spaces.Discrete(3),
            }
        )
        ...
        self._00 = self._diamond_to_obs[self.diamond_matrix[0,0]]
        self._01 = self._diamond_to_obs[self.diamond_matrix[0,1]]
        self._02 = self._diamond_to_obs[self.diamond_matrix[0,2]]
        self._03 = self._diamond_to_obs[self.diamond_matrix[0,3]]
        self._10 = self._diamond_to_obs[self.diamond_matrix[1,0]]
        self._11 = self._diamond_to_obs[self.diamond_matrix[1,1]]
        self._12 = self._diamond_to_obs[self.diamond_matrix[1,2]]
        self._13 = self._diamond_to_obs[self.diamond_matrix[1,3]]
        self._20 = self._diamond_to_obs[self.diamond_matrix[2,0]]
        self._21 = self._diamond_to_obs[self.diamond_matrix[2,1]]
        self._22 = self._diamond_to_obs[self.diamond_matrix[2,2]]
        self._23 = self._diamond_to_obs[self.diamond_matrix[2,3]]
        self._30 = self._diamond_to_obs[self.diamond_matrix[3,0]]
        self._31 = self._diamond_to_obs[self.diamond_matrix[3,1]]
        self._32 = self._diamond_to_obs[self.diamond_matrix[3,2]]
        self._33 = self._diamond_to_obs[self.diamond_matrix[3,3]]
    ...
    def _get_obs(self):
        return {"agent": self._agent_location, "00": self._00, "01": self._01, "02": self._02,"03": self._03,"10": self._10,"11": self._11,"12": self._12,"13": self._13,"20": self._20,"21": self._21,"22": self._22,"23": self._23,"30": self._30,"31": self._31,"32": self._32,"33": self._33} # , "target": self._target_location
    ...
    def step(self, action):
        ...
        if np.array_equal(self._agent_location, np.array([1,2])):
            ...
            self.diamond_matrix[3,0] = -1
            self.diamond_matrix[1,2] = -1
    ...
    def createTable(self):
        self.table = np.zeros((4  ,3,3,3,3,3,3,3,1,3,3,3,3,3,3,3,3, 4))
