from gridworld8_0 import GridWorldEnv8_0
from gridworld8_1 import GridWorldEnv8_1
import gym
import time
...
env = GridWorldEnv8_0(render_mode="rgb_array")
#env = DummyVecEnv([lambda: env]) 
model = PPO('MultiInputPolicy',env,verbose=1,tensorboard_log=log_path)
obs = env.reset()

env_see = GridWorldEnv8_0(render_mode="human")
...
env_see = GridWorldEnv8_1(render_mode="human")
times_to_execute = 10
while times_to_execute > 0:
    obs = env_see.reset(exec=True)
    times_to_execute -= 1
