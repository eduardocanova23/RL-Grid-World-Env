...
class GridWorldEnv7(gym.Env):
    ...
    def __init__(self,render_mode=None,size=4,exploration_max=0.90,exploration_min=0,exploration_decay=1.0,gamma=0.9,max_steps=18,learning_rate=0.9):
        ...
        self.reward_matrix = np.array([[-1,-1,-1,-1],[-1,-1,3,10], [-1,-1,5,2],[4,4,4,4]])
        # Observations are dictionaries with the agent's and the target's location.
        # Each location is encoded as an element of {0, ..., `size`}^2, i.e. MultiDiscrete([size, size]).
        self.observation_space = spaces.Dict(
            {
                "agent": spaces.Box(0, size - 1, shape=(2,), dtype=int),
                "left": spaces.Discrete(6),
                "right": spaces.Discrete(6),
                "up": spaces.Discrete(6),
                "down": spaces.Discrete(6),
            }
        )
    ...
    def reset(self, seed=None, options=None, exec=False):
        ...
        self.total_reward = 0
        self.reward_matrix = np.array([[-1,-1,-1,-1],[-1,-1,3,10], [-1, -1,2,5],[4, 4,4,4]])
        self.diamond_matrix = np.array([[0,0,0,0],[0,0,"b",0],[0,0,"b","b"],["y","y","y","y"]])
        self.collected_first = None
        ...
        self._ydiamond_location1 = np.array([3,3])
        self._ydiamond_location2 = np.array([3,2])
        self._ydiamond_location3 = np.array([3,1])
        self._ydiamond_location4 = np.array([3,0])

        self._bdiamond_location2 = np.array([2,3])
        self._bdiamond_location3 = np.array([1,2])
        self._bdiamond_location5 = np.array([2,2])
    ...
    def step(self, action):
        ...
        if np.array_equal(self._agent_location, np.array([3,0])):
            ...
            if self.collected_first == None:
                self.collected_first = "yellow"
                self.reward_matrix[1,2] = -1
                self.reward_matrix[2,2] = -1
                self.reward_matrix[2,3] = -1

                self._bdiamond_location2 = np.array([4,4])
                self._bdiamond_location3 = np.array([4,4])
                self._bdiamond_location5 = np.array([4,4])

        elif np.array_equal(self._agent_location, np.array([3,1])):
            self.reward_matrix[3,1] = -1
            if self.collected_first == None:
                self.collected_first = "yellow"
                self.reward_matrix[1,2] = -1
                self.reward_matrix[2,2] = -1
        ...
        elif np.array_equal(self._agent_location, np.array([3,3])):
            ...
            self.reward_matrix[1,2] = -1
            if self.collected_first == None:
                self.collected_first = "blue"
                self.reward_matrix[3,0] = -1
                self.reward_matrix[3,1] = -1
                self.reward_matrix[3,2] = -1
                self.reward_matrix[3,3] = -1

                self._ydiamond_location1 = np.array([4,4])
                self._ydiamond_location2 = np.array([4,4])
                self._ydiamond_location3 = np.array([4,4])
                self._ydiamond_location4 = np.array([4,4])
    ...
    def _render_frame(self):
        ...
        pygame.draw.rect(
            ...
            (0, 230, 230),
            pygame.Rect(
                pix_square_size * self._bdiamond_location2,
                (pix_square_size, pix_square_size),
            ),
        )
        ...
        pygame.draw.rect(
            ...
            (0, 230, 230),
            pygame.Rect(
                pix_square_size * self._bdiamond_location3,
                (pix_square_size, pix_square_size),
            ),
        )
        ...
        pygame.draw.rect(
            ...
            (0, 230, 230),
            pygame.Rect(
                pix_square_size * self._bdiamond_location5,
                (pix_square_size, pix_square_size),
            ),
        )
        ...
        pygame.draw.rect(
            ...
            (230, 230, 0),
            pygame.Rect(
                pix_square_size * self._ydiamond_location1,
                (pix_square_size, pix_square_size),
            ),
        )
        ...
        pygame.draw.rect(
            ...
            (230, 230, 0),
            pygame.Rect(
                pix_square_size * self._ydiamond_location2,
                (pix_square_size, pix_square_size),
            ),
        )
        ...
        pygame.draw.rect(
            ...
            (230, 230, 0),
            pygame.Rect(
                pix_square_size * self._ydiamond_location3,
                (pix_square_size, pix_square_size),
            ),
        )
        ...
        pygame.draw.rect(
            ...
            (230, 230, 0),
            pygame.Rect(
                pix_square_size * self._ydiamond_location4,
                (pix_square_size, pix_square_size),
            ),
        )
    ...
    def createTable(self):
        self.table = np.zeros((4, 4, 6,6,6,6, 4))
